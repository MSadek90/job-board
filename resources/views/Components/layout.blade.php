...
<body class="bg-slate-50">
    <div class="flex min-h-screen">
        ...
        <div class="flex-1 ml-64 min-h-screen flex flex-col">
            <header class="h-20 bg-white border-b border-slate-200 px-8 flex items-center justify-end shrink-0">
                @guest
                <div class="flex items-center gap-3">
                    <a href="{{ route('login.show') }}"
                        class="px-5 py-2.5 rounded-xl text-sm font-medium text-slate-700 border border-slate-300 hover:bg-slate-50">
                        Login
                    </a>

                    <a href="{{ route('signup.show') }}"
                        class="px-5 py-2.5 rounded-xl text-sm font-medium text-white bg-indigo-600 hover:bg-indigo-700">
                        Sign Up
                    </a>
                </div>
                @endguest
                ...
                <div class="relative">
                    <button id="userMenuButton" type="button"
                        ...
                        <div class="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 text-white flex items-center justify-center font-semibold">
                    ...
                    <div id="userDropdown"
                        class="hidden absolute right-0 mt-3 w-44 bg-white border border-slate-200 rounded-xl shadow-lg z-50">
